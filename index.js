var S = {
    init: function () {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('|#countdown 10|我的雨洁宝宝~|这是我陪你过的第一个生日|以后你的每个生日我都要陪你度过!|我可爱的小寿星|我只希望你每天都快快乐乐|平平安安|你的慕慕宝宝|永远爱你|❤|祝你|生日快乐！|');
        }
...
S.Dot.prototype = {
    ...
    _update: function () {
        ...
        d = this.p.a - this.t.a;
        this.p.a = Math.max(0, this.p.a - (d * 0.05));
        d = this.p.z - this.t.z;
